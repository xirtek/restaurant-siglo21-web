...
<html lang="en">
    ...
    Conexion cn = new Conexion();
            PreparedStatement ps10;
                ...
                String sql10 = "SELECT * FROM MESA WHERE DISPONIBILIDAD = ?";
                con = cn.getConexion();
        ...
        <div class="limiter">
            <div class="container-login100">
                <div class="wrap-login100">
                    <br>
                    <br>
                    <H2 style="padding-left: 30%">REALIZA TU PEDIDO</H2>
                    ...
                    <form class="login100-form validate-form" action="" method="POST">
                        ...
                        <div class=" validate-input m-b-18" data-validate = "debe ingrresar el numero de mesa" style="width: 100%">
                            <span class="label-input100">Numero de Mesa</span>
            <select name="nroMesa" required="" class="form-control">
                ...
                <option value="<%=rs10.getInt("ID_MESA")%>"><%=rs10.getInt("ID_MESA")%></option>
...
<%
    ...
    if (nombreCliente != null && nromesa != null) {
        ...
        me.setId_mesa(nrmesa);
        me.setDisponibilidad('n');
        
        mbo.modificarMesa(nrmesa,'n');
       
        
            
            sesion.setAttribute("DispoNumeroMesa", nrmesa);
