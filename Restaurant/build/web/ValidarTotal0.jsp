<%-- 
    Document   : ValidarTotal0
    Created on : 08-12-2019, 21:30:18
    Author     : Raul
--%>
        ...
        <div class="container">               
            ...
            <body style=" ">
                ...
                <div style="background: #ECEBEB; width: 55%; margin: 15% 25%">
                    <br>
                    <h1 style="text-align:center; " ><b>No puede finalizar la compra sin la realizacion de un pedido</b></h1>
                    <form action="AgregarOrden.jsp"  method="post"  style="margin: 5% 30%; width: 40%; height: 50%; text-align:center;">
